...
public class ContextWriteFinException extends ContextWriteException {
     ...
     *
     * @param n the number of messages the context has written before finish
     */
    public ContextWriteFinException(int n) {
        super(String.format(
                    "The context is already finished writing " +
                    "after the %sth message",
                    n),
                null);
    }
}
