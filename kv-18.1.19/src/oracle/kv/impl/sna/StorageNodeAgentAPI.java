...
public final class StorageNodeAgentAPI extends RemoteAPI {
    ...
    /**
     * getStorageNodeInfo() added in version 12.
     */
    private static final short GET_SN_INFO_SERIAL_VERSION = SerialVersion.V12;

    /**
     * checkParams() added in version 13.
     */
    private static final short CHECK_PARAMS_SERIAL_VERSION = SerialVersion.V13;
    ...
    public void checkParameters(ParameterMap params, ResourceId id)
        throws RemoteException {
        checkSerialVersion(CHECK_PARAMS_SERIAL_VERSION, "checkParameters");
    ...
    public StorageNodeInfo getStorageNodeInfo() throws RemoteException {
        checkSerialVersion(GET_SN_INFO_SERIAL_VERSION, "getStorageNodeInfo");
    ...
    public KrbPrincipalInfo getKrbPrincipalInfo()
        throws RemoteException {
        checkSerialVersion(KERBEROS_AUTHENTICATION_SERIAL_VERSION,
                           "getKrbPrincipalInfo");
    ...
    private void changedInR2(String method) {
        /*
         ...
         */
        checkSerialVersion(SerialVersion.V2, method);
    }
